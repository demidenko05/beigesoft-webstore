...
alter table PURCHASERETURNLINE add column TAXCATEGORY bigint unsigned default null;
alter table PURCHASERETURNLINE add FOREIGN KEY (TAXCATEGORY) references INVITEMTAXCATEGORY(ITSID);
