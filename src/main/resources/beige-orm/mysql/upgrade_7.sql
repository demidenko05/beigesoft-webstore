...
alter table SETTINGSADD add column SPECHTMLSTART varchar(50) default null;
alter table SETTINGSADD add column SPECHTMLEND varchar(50) default null;
alter table SETTINGSADD add column SPECGRHTMLSTART varchar(50) default null;
alter table SETTINGSADD add column SPECGRHTMLEND varchar(50) default null;
