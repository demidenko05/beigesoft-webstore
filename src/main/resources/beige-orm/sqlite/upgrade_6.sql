...
insert into ACCENTRIESSOURCESLINE (ITSID, ITSOWNER, FILENAME, ITSVERSION, SOURCETYPE, SETCODE, ISUSED, ENTRIESSOURCETYPE, ENTRIESACCOUNTINGTYPE, SOURCEIDNAME, DESCRIPTION) values (37, 1, 'SalesReturnsInvItCatDbRetPayDebtorCrAccrMSm', 1462867931627, 12, 'InvItemCategory,DebtorCreditor', 1, 0, 1, 'SALESRETURN.ITSID', 'SalesReturn, Debit SalesReturns.InvItemCategory Credit ReturnsPayable.DebtorCreditor for Subtotal amount. Accrual Symmetric.');
