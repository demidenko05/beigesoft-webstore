select SERVICESPECIFICS.ITSVERSION as ITSVERSION, SERVICESPECIFICS.LONGVALUE2 as LONGVALUE2, ITEM.ITSID as ITEMITSID, SERVICESPECIFICS.LONGVALUE1 as LONGVALUE1,
case when I18NSERVICETOSALE.ITSNAME is null then ITEM.ITSNAME else I18NSERVICETOSALE.ITSNAME end as ITEMITSNAME,
...
left join SERVICETOSALE as ITEM on SERVICESPECIFICS.ITEM=ITEM.ITSID
...
left join (select ITSNAME, HASNAME from I18NSERVICETOSALE where HASNAME=:ITEMID and LANG=':LANG') as I18NSERVICETOSALE on I18NSERVICETOSALE.HASNAME=ITEM.ITSID
