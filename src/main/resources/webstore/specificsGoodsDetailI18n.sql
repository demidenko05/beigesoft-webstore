select GOODSSPECIFICS.ITSVERSION as ITSVERSION, GOODSSPECIFICS.LONGVALUE2 as LONGVALUE2, GOODS.ITSID as GOODSITSID, GOODSSPECIFICS.LONGVALUE1 as LONGVALUE1,
...
from GOODSSPECIFICS
left join INVITEM as GOODS on GOODSSPECIFICS.ITEM=GOODS.ITSID
...
left join (select ITSNAME, HASNAME from I18NINVITEM where HASNAME=:ITEMID and LANG=':LANG') as I18NINVITEM on I18NINVITEM.HASNAME=GOODS.ITSID
