...
/**
 * <p>
 * Model of I18N name of goods/services specifics group.
 * </p>
 *
 * @author Yury Demidenko
 */
public class I18nSpecificsOfItemGroup
  extends AI18nName<SpecificsOfItemGroup, IdI18nSpecificsOfItemGroup> {

  /**
   * <p>ID.</p>
   **/
  private IdI18nSpecificsOfItemGroup itsId = new IdI18nSpecificsOfItemGroup();
   ...
   * @return IdI18nSpecificsOfItemGroup
   **/
  @Override
  public final IdI18nSpecificsOfItemGroup getItsId() {
    return this.itsId;
  }
   ...
   **/
  @Override
  public final void setItsId(final IdI18nSpecificsOfItemGroup pItsId) {
    this.itsId = pItsId;
    if (this.itsId == null) {
      this.lang = null;
      this.hasName = null;
