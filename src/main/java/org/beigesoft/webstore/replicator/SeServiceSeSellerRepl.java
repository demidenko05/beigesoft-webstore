...
/**
 * <p>Service to fill S.E.Seller in SeService.</p>
 *
 * @author Yury Demidenko
 */
public class SeServiceSeSellerRepl implements ISrvEntityFieldFiller {
  ...
  public final void fill(final Map<String, Object> pAddParam,
    ...
    try {
      ...
      seService.setSeller(ownedEntity);
    } catch (Exception ex) {
      throw new ExceptionWithCode(ExceptionWithCode
