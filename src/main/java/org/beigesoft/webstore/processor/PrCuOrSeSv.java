...
/**
 * <p>Service that change customer S.E. order status. It's possible:
 * <ul>
...
public class PrCuOrSeSv<RS> implements IEntityProcessor<CuOrSe, Long> {
   ...
   **/
  @Override
  public final CuOrSe process(final Map<String, Object> pRqVs,
    final CuOrSe pEntity, final IRequestData pRqDt) throws Exception {
    ...
    if (pEntity.getIsNew()) {
      ...
      oco = this.srvOrm.retrieveEntityById(pRqVs, CuOrSe.class,
        pEntity.getItsId());
